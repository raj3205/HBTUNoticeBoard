                    ...
                    mAuth.sendPasswordResetEmail(email).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if(task.isSuccessful()){
                                Toast.makeText(ForgotPassword.this,"Reset Password link send on your Email Id",Toast.LENGTH_SHORT).show();
                            }else {
                                Toast.makeText(ForgotPassword.this,"Enter valid Email Id which is already registered",Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                }
